...
export class TransactionsController {
    ...
    static async create(req, res, next) {
        try {
            ...
            const transaction = await TransactionsService.createTransaction(req.user.id, req.params.portfolioId, {
                ...req.body,
    ...
    static async getByPortfolio(req, res, next) {
        try {
            const errors = validationResult(req);
            if (!errors.isEmpty()) {
                return ResponseHelper.badRequest(res, errors.array(), 'Validation failed');
            ...
            const result = await TransactionsService.getPortfolioTransactions(req.user.id, req.params.portfolioId, page, limit);
