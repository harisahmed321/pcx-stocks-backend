...
export class RolePermissionsController {
    ...
    static async upsertPermission(req, res, next) {
        try {
    ...
    static async bulkUpsertPermissions(req, res, next) {
        try {
            ...
            for (const perm of permissions) {
                ...
                if (!perm.role || !perm.page || !perm.accessType) {
                    return ResponseHelper.badRequest(res, null, 'Each permission must have role, page, and accessType');
                }
