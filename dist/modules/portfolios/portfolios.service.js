...
export class PortfoliosService {
    static async createPortfolio(userId, data) {
    ...
    static async getPortfolioById(userId, portfolioId) {
    ...
    static async updatePortfolio(userId, portfolioId, data) {
        // Check ownership
    ...
    static async deletePortfolio(userId, portfolioId) {
        // Check ownership
        const existing = await prisma.portfolio.findFirst({
            where: { id: portfolioId, userId }
        });
