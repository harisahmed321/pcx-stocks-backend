...
export class MarketSimulatorJob {
    ...
    HISTORY_SIZE = 10; // Keep last 10 prices for trend calculation
    constructor(marketGateway, updateIntervalMs = 3000) {
    ...
    async generateAndBroadcastUpdates() {
    ...
    applyTrendAdjustment(symbol, basePrice) {
...
//# sourceMappingURL=market-simulator.job.js.map